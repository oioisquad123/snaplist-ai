...
const posts = [
  {
    ...
    readTime: "5 min read",
    excerpt:
      "The best free AI eBay listing generator — upload 1-4 photos, get a keyword-rich title, description, suggested price, category, and item specifics in ~8 seconds. No signup needed.",
    tags: ["eBay", "AI Tools", "Free"],
    emoji: "🤖",
    isNew: true,
  },
  {
